...
const CASE_DETAILS: Record<string, CaseDetail> = {
  ...
  'Shapoorji Pallonji': {
    period: 'Brand & integrated media strategy',
    // Tower flyer as the hero, in the order sent — same three images and
    // order as caseStudies.ts.
    media: [
    ...
    metrics: [
      { value: '12L', label: 'Campaign views' },
      { value: '613K', label: 'Facebook followers' },
      { value: '155+', label: 'Years heritage' },
    ],
  },
}
